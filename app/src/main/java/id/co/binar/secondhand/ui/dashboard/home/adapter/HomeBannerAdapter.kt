...
class HomeBannerAdapter : ListAdapter<GetBannerResponse, RecyclerView.ViewHolder>(diffUtilCallback) {
...
private val diffUtilCallback = object : DiffUtil.ItemCallback<GetBannerResponse>() {
